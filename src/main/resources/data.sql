...
VALUES ('Абрикосы', 1, 0, 10, 45),
       ...
       ('Фасоль в томатном соусе', 5, 0, 15, 86),
       ('Фенхель', 1, 0, 7, 31),
       ...
       ('Щавель', 2, 0, 5, 25),
       ('Яблоки', 1, 1, 13, 60),
       ('Яблоки сушёные', 3, 0, 66, 269),
       ('Яйца', 15, 13, 1, 162);

-- Dump completed on 2021-06-14 20:52:00
